...
$().ready(function() {
  ...
  function lastWeek() {
      ...
      var stopDate = moment(startDate).subtract(6, 'days');
      
          var week = [];
          while (stopDate <= startDate) {
              week.push(moment(new Date (startDate)).format("MMM DD"));
...
//Pie chart for main page 
      ...
      var data = {
          labels: labelNames,
            series: [
            [1300, 1644, 1230, 1750, 1575, 1560, 1380,],
          ]
        }; 
        console.log("hi");
        ...
        new Chartist.Bar('#chartCalories', data, options, responsiveOptions);
